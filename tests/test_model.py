...
def test_score_healthy_account_high_prob():
    ...
    healthy = {
        "id": "h", "name": "h", "tier": "gold", "arr": 100000,
        "contract_end": "2027-04-01", "engagement_decay": 0.0,
        "avg_csat_3mo": 4.8, "p1_count_30d": 0, "usage_growth_pct": 80,
        "module_gap_count": 0, "exec_sponsor_present": 1,
        "previous_renewal_count": 1, "contract_months_in": 8,
    }
...
def test_score_silent_churner_low_prob():
    coefs = load_coefficients()
    churner = {
        "id": "c", "name": "c", "tier": "gold", "arr": 100000,
        "contract_end": "2026-09-01", "engagement_decay": 0.85,
        "avg_csat_3mo": 4.0, "p1_count_30d": 0, "usage_growth_pct": -60,
        "module_gap_count": 0, "exec_sponsor_present": 0,
        "previous_renewal_count": 0, "contract_months_in": 14,
    }
...
def test_arr_at_risk_calculation():
    coefs = load_coefficients()
    a = {
        "id": "a", "name": "a", "tier": "gold", "arr": 200000,
        "contract_end": "2027-01-01", "engagement_decay": 0.5,
        "avg_csat_3mo": 4.0, "p1_count_30d": 1, "usage_growth_pct": 0,
        "module_gap_count": 0, "exec_sponsor_present": 1,
        "previous_renewal_count": 0, "contract_months_in": 10,
    }
...
def test_contributions_sum_close_to_z():
    coefs = load_coefficients()
    a = {
        "id": "a", "name": "a", "tier": "gold", "arr": 100000,
        "contract_end": "2027-01-01", "engagement_decay": 0.3,
        "avg_csat_3mo": 4.5, "p1_count_30d": 0, "usage_growth_pct": 20,
        "module_gap_count": 0, "exec_sponsor_present": 1,
        "previous_renewal_count": 0, "contract_months_in": 6,
    }
    s = score_account(a, coefs)
